...
class Checkout extends Component {
	...
	componentDidMount() {
		...
		if (pathname === paymentStep)
			this.setState({
				header: this.props.translate('checkout.paymentTitle')
			});
		else if (pathname === shippingStep)
			this.setState({
				header: this.props.translate('checkout.customerTitle')
			});
	}
	componentDidUpdate(prevProps, prevState) {
		...
		if (prevProps.location !== this.props.location) {
			...
			else if (pathname === confirmationStep)
				this.setState({
					header: this.props.translate('checkout.confirmTitle')
				});
		}
	}
								...
								<div className='col-8'>
									<div className='header-options'>
										...
										>
											...
											{translate('checkout.paymentTitle')}{' '}
											<div>
												<i className='icon-arrow-down' />
											</div>
										</button>
										...
										>
											<i className='icon-delivered-step' />{' '}
											{translate('checkout.orderTitle')}{' '}
											<div>
												<i className='icon-arrow-down' />
											</div>
										</button>
							...
							render={() => {
								return (
									<CheckoutShipping
										...
										confirmUserAddress={
											this.props.confirmUserAddress
										}
										onShowGoogleMap={
											this.handleShowGoogleMap
										}
										...
										completeShipping={
											this.props.completeShipping
										}
										changeDefaultAddress={
											this.props.changeDefaultAddress
										}
									/>
								);
							}}
