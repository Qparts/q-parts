  ...
  return (
   <form onSubmit={handleSubmit}>
    <div className="ShippingCity-item">
     ...
     <div>
      <RadioButton value='termsOfConditions' name="termsOfConditions" onChange={this.handleChange} checked={'termsOfConditions' === this.state.termsOfConditions} />
      <label className="p-radiobutton-label">{translate("shippingCity.termsCondition")}</label>
     </div>
    </div>
