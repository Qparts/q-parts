  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <SmallScreen>
          <form className="profile-mobile" onSubmit={this.props.handleSubmit}>
            <div className="Profile-container">
              <div className="Profile-info-box border rounded">
                <div className="info-title">
                  <p>{translate("setting.accountSetting.info.title")}</p>
                ...
                <div className="info-body">
                  ...
                  <div className="Profile-info-box_item Profile-name row">
                    <div className="col-12 first-Name">
                      <Field
                        label={translate("setting.accountSetting.info.label")}
                        name="firstName"
                        component={RenderField}
                    ...
                    <div className="col-12 last-name">
                      <Field
                        label={translate("setting.accountSetting.info.label")}
                        name="lastName"
                        component={RenderField}
                    ...
                    <div className="col-12 phone-info">
                        ...
                        <div className="col-9 phone-number">
                          <Field
                            name="phone-number"
                            component={RenderField}
                            placeholder="Phone Number"
              ...
              <div className="Profile-access-box border rounded">
                ...
                <div className="Profile-access-box_item">
                  <Field
                    ...
                    placeholder={translate("setting.accountSetting.access.email")}
                    hasFloatLabel />
                  <Link to="#" className="btn btn-secondary col-12" onClick={this.props.onShowEditDialog.bind(this, editPassword)} ><p><i className={`icon-arrow-${right(direction)}`} />{translate("setting.accountSetting.access.passwordButton")}</p></Link>
                </div>
              </div>
              <br />
              <div className="Profile-notification-box border rounded">
