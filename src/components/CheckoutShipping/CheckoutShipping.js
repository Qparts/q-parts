...
class CheckoutShipping extends Component {
  ...
  handleDeliveryNoAddress = values =>{
    console.log(values)
          ...
          this.props.showGoogleMap ? (
            ...
            <div className="Address-container col-12 col-md-9">
              <div className="addresses-header justify-content-between ">
                ...
                <Button type="button" className={this.state.hasNewAddress? "hide" : "btn btn-primary"} icon="icon-add" text={translate("setting.addressBook.add")} onClick={this.handleAddNewAddress} isReverseOrder />
              </div>
      ...
      haveAddress=<Fragment>{
        this.props.showGoogleMap ? (
          ...
          <div className="Address-container col-12 col-md-9">
            ...
            <form onSubmit={handleSubmit(this.handleDeliveryNoAddress)}>
              ...
              <Button type="submit" className="btn btn-secondary" text={translate("form.address.buttons.deliver")} icon={`icon-arrow-${right(direction)}`} />
            </form>
          </div>
      }
    </Fragment>
