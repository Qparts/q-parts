          ...
          <TabContent activeTab={this.state.activeTab}>
            <TabPane tabId="pending">
                  <ul className="list-unstyled" id="request-list">
                    <li>
                      <a className="collapsed" data-toggle="collapse" href="#request-id" role="button" aria-expanded="false" aria-controls="request-id">
                        <LargeScreen>
                      ...
                      <div class="collapse" id="request-id" data-parent="#request-list">
                          ...
                          <div className="parts-list">
                            <ul className="d-table list-unstyled">
                              <li className="d-table-row">
                                <div className="d-table-cell">Part Name</div>
                                <div className="d-table-cell">Quantity</div>
                              </li>
                              <li className="d-table-row">
                                <div className="d-table-cell">Oil Filter</div>
                                <div className="d-table-cell">1</div>
                              </li>
                            </ul>
                          </div>
            ...
            <TabPane tabId="replayed">
                  <ul className="list-unstyled" id="replayed-list">
                    <li>
                      <a className="collapsed" data-toggle="collapse" href="#replayed-id1" role="button" aria-expanded="false" aria-controls="replayed-id1">
                        <LargeScreen>
                          <div className="col-lg-auto">
                            <label>Request Num</label>
                            <p>#xxx11xx</p>
