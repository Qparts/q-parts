...
class listingVechile extends Component {
  ...
  render() {
            ...
            >
              <div className="row">
                ...
                <div className="col-md-auto">
                  <button type="submit" className="btn btn-primary">
                    Go <i className="icon-arrow-right"></i>
                  </button>
                </div>
              </div>
            </form>
    ...
    return <div className="selected-vechile">{selectedVechileModule}</div>;
  }
}
...
const withListingVechile = withRouter(listingVechile)
export default connect(mapStateToProps, mapDispatchToProps)(withListingVechile);
