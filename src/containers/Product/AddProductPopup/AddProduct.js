        ...
        <section id="AddProduct" className="container-fluid">
          <form className="row" onSubmit={this.props.handleSubmit}>
              ...
              <div className="btn-footer col-12">
                ...
                <button className="check-out w3-right">Check Out<i className="icon-arrow-right" /></button>
          ...
          <form onSubmit={this.props.handleSubmit}>
            <div className="row">
              ...
              <div className="btn-footer col-12">
                ...
                <button className="check-out">Check Out<i className="icon-arrow-right" /></button>
              </div>
            </form>
          </div>
        </section>
