...
import {
	...
	QUOTATION_ORDER_INOF, SET_QUOTATION_VALUES, PUT_COMPLETED_REQUEST_READ, GET_CLOSED_REQUESTS
...
export default function reducer(state = initialState, action) {
	switch (action.type) {
		...
		case GET_CLOSED_REQUESTS:
			const closed = { ...state.quotations, closed: action.payload };

			return { ...state, quotations: closed }
