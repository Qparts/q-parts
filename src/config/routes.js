...
import CatalogueGroupsListing from '../components/catalogue/CatalogueGroupsListing';
import GroupDetails from '../components/catalogue/GroupDetails';
import SubGroupDetails from '../components/catalogue/SubGroupDetails.js';
...
export const routes = (isAuth, direction, defaultLang, translate) => [
	...
	{
	    path: "/selected-vehicle",
	    component:  HomeSelectedVehicle,
	    currentLanguage: defaultLang
	},
	{
		path: '/listing-vechile',
		component: ListingVechile
	},
	{
			path: "/model-list",
			component:  ModelList,
	...
	{
			path: "/catalogue-groups-listing",
			component:  CatalogueGroupsListing,
			currentLanguage: defaultLang
	},
	{
			path: "/group-details",
